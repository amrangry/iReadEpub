        ...
        return stream(
            ...
            completion: { result in
                ...
                case let .success(response):
                    let model = HTTPDownload(location: location, suggestedFilename: suggestedFilename ?? response.filename, mediaType: response.mediaType, response: response)
...
public struct HTTPDownload {
    ...
    public init(location: URL, suggestedFilename: String? = nil, mediaType: MediaType, response: HTTPResponse) {
