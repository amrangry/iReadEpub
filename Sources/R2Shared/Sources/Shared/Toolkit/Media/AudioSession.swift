...
public protocol AudioSessionUserProtocol: AnyObject {
...
/// Inline Doc
public extension AudioSessionUserProtocol {
...
public final class AudioSession: Loggable {
    ...
    private weak var user: AudioSessionUserProtocol?

    /// Starts a new audio session with the given `user`.
    public func start(with user: AudioSessionUserProtocol) {
    ...
    public func end(for user: AudioSessionUserProtocol) {
